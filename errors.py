...
def type_exception(var_name: str, expected_type: type | str, line: int) -> TypeError:
...
def type_exception_with_value(var_name: str, value, expected_type: str, line: int) -> TypeError:
